...
export function FinalCta() {
  return (
    <section className="py-16">
      <div className="page-wrap overflow-hidden rounded-[2rem] bg-coral px-6 py-14 text-center text-white sm:px-12">
        <p className="font-label text-xs font-semibold uppercase tracking-[0.22em] text-white/80">
          Ready when they are
        </p>
        <h2 className="mx-auto mt-3 max-w-2xl font-heading text-4xl text-paper sm:text-5xl">
